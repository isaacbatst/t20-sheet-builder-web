...
import { MartialWeaponName, SerializedSheetEquipment, SimpleWeaponName } from 't20-sheet-builder';
...
export const {submitInitialEquipment} = sheetBuilderSliceInitialEquipment.actions
