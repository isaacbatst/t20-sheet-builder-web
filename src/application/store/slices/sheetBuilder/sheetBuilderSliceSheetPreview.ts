...
export const selectPreviewDisplacement = (state: RootState) => state.sheetBuilder.sheet.preview.displacement
...
export const selectPreviewInventory = (state: RootState) => state.sheetBuilder.sheet.preview.equipments
