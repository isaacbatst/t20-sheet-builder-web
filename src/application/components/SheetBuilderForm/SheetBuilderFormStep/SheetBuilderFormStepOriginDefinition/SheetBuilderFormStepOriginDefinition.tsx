...
import OriginBenefitsSelect, { OriginBenefitOption } from './OriginBenefitsSelect'
...
const SheetBuilderFormStepOriginDefinition = () => {
  ...
  const [selectedBenefits, setSelectedBenefits] = React.useState<OriginBenefitOption[]>([])
