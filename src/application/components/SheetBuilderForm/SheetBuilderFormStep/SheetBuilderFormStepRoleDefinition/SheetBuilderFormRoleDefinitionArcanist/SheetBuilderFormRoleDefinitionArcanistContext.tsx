...
import { ArcanisPathWizardFocusName, ArcanistLineageDraconicDamageType, ArcanistLineageType, ArcanistPathName, Attribute, GeneralPowerName, SkillName, SpellName } from "t20-sheet-builder";
...
export type ArcanistFormContextType = {
  ...
  setSorcererLineage(lineage?: ArcanistLineageType): void
	setSorcererLineageDraconicDamageType(damageType?: ArcanistLineageDraconicDamageType): void
...
const ArcanistFormContext = React.createContext(null as unknown as ArcanistFormContextType) 

export const ArcanistFormContextProvider: React.FC<PropsWithChildren> = ({
  children
}) => {
  const form = useArcanistForm()
  return <ArcanistFormContext.Provider value={form}>
    {children}
